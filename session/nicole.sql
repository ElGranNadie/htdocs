...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-12-2024 a las 21:24:06
...
--
ALTER TABLE `mensajes`
  ADD CONSTRAINT `mensajes_ibfk_1` FOREIGN KEY (`UsuarioID`) REFERENCES `usuario` (`idusuario`);
...
--
ALTER TABLE `solicita`
  ADD CONSTRAINT `solicita_ibfk_1` FOREIGN KEY (`UsuarioID`) REFERENCES `usuario` (`idusuario`),
  ADD CONSTRAINT `solicita_ibfk_2` FOREIGN KEY (`RecetaID`) REFERENCES `receta` (`idreceta`);
COMMIT;
