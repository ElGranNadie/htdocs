...
$quehacemos = "/dashboard/que-hacemos.php";       
    ...
    <div class="container-fluid"> 
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo $quehacemos ?>">¿Qué Hacemos?</a></li>
                ...
                <li class="nav-item">
                        <?php if ($user_id): ?>
                            <span class="text-light fw-bold">👤 <?php echo htmlspecialchars($nombre_usuario); ?></span>
                            ...
                            <?php elseif ($es_premium): ?>
                                <span class="nav-link">✨ Ya eres Premium</span>
                            <?php endif; ?>
