...
/// @endcond
    ...
    /**
 * @var string $correo
 * Correo electrónico ingresado por el usuario desde el formulario de login.
 */
    $correo = trim($_POST['correo']); 
    $password = trim($_POST['pass']);
    ...
    /**
    * @var array $errores
    * Almacena los mensajes de error generados durante el proceso de validación y autenticación.
    * Se utiliza para redirigir al usuario con retroalimentación si el login falla.
    */
    $errores = [];
    ...
    * 
    * - Se aplica la función validarCorreo() para asegurar que el formato sea correcto.
    * - Si la validación retorna errores, se agregan al arreglo $errores.
    */
    $validCorreo = validarCorreo($correo);
